...
class LiveStreamEndSheet extends StatelessWidget {
  ...
  const LiveStreamEndSheet({Key? key, required this.name, required this.onExitBtn})
      : super(key: key);
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style:
                  const TextStyle(color: ColorRes.black, fontSize: 19, fontFamily: FontRes.regular),
            ),
            const Spacer(),
          ],
        ),
