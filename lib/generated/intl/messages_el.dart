...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "amount":
            MessageLookupByLibrary.simpleMessage("Ποσό που καταβάλλεται:"),
        ...
        "appLanguages":
            MessageLookupByLibrary.simpleMessage("Γλώσσες εφαρμογών"),
        ...
        "chatHint":
            MessageLookupByLibrary.simpleMessage("Πληκτρολόγησε κάτι...!"),
        "chatWith": MessageLookupByLibrary.simpleMessage("ΣΥΖΗΤΗΣΗ ΜΕ"),
        "checkOutThisProfile":
            MessageLookupByLibrary.simpleMessage("Ελέγξτε αυτό το Προφίλ"),
        ...
        "continuePlease":
            MessageLookupByLibrary.simpleMessage("  συνέχισε παρακαλώ"),
        "continueText": MessageLookupByLibrary.simpleMessage("Να συνεχίσει"),
        "continueWithApple":
            MessageLookupByLibrary.simpleMessage("Συνεχίστε με την Apple"),
        "continueWithFacebook":
            MessageLookupByLibrary.simpleMessage("Συνέχεια με το Facebook"),
        "continueWithGoogle":
        ...
        "drivingLicence":
            MessageLookupByLibrary.simpleMessage("Δίπλωμα οδήγησης"),
        "edit": MessageLookupByLibrary.simpleMessage("ΕΠΕΞΕΡΓΑΣΙΑ"),
        "editProfile":
            MessageLookupByLibrary.simpleMessage("ΕΠΕΞΕΡΓΑΣΙΑ ΠΡΟΦΙΛ"),
        "eligibility":
            MessageLookupByLibrary.simpleMessage("Καταλληλότητα ζωντανής ροής"),
        ...
        "enterAbout":
            MessageLookupByLibrary.simpleMessage("Εισαγάγετε ΣΧΕΤΙΚΑ"),
        ...
        "enterEmail":
            MessageLookupByLibrary.simpleMessage("Εισαγάγετε το Email"),
        "enterFullName":
            MessageLookupByLibrary.simpleMessage("Εισαγάγετε το πλήρες όνομα"),
        "enterFullReason":
            MessageLookupByLibrary.simpleMessage("Εισαγάγετε τον πλήρη λόγο"),
        ...
        "explainMore":
            MessageLookupByLibrary.simpleMessage("Εξηγήστε περισσότερα"),
        "explore": MessageLookupByLibrary.simpleMessage("Εξερευνώ"),
        "exploreProfiles":
            MessageLookupByLibrary.simpleMessage("Εξερευνήστε τα προφίλ"),
        ...
        "hideInfo":
            MessageLookupByLibrary.simpleMessage("ΑΠΟΚΡΥΨΗ ΠΛΗΡΟΦΟΡΙΩΝ"),
        ...
        "imageIsEmpty":
            MessageLookupByLibrary.simpleMessage("Η εικόνα είναι κενή"),
        "inappropriateContent":
            MessageLookupByLibrary.simpleMessage("Ακατάλληλο περιεχόμενο"),
        ...
        "intro":
            MessageLookupByLibrary.simpleMessage("ΣΥΝΤΟΜΗ ΕΙΣΑΓΩΓΗ ΒΙΝΤΕΟ"),
        ...
        "liveCap": MessageLookupByLibrary.simpleMessage("ΖΩ"),
        "liveStreamCap":
            MessageLookupByLibrary.simpleMessage("ΑΠΕΥΘΕΙΑΣ ΜΕΤΑΔΟΣΗ"),
        "liveStreamEnded":
            MessageLookupByLibrary.simpleMessage("Η ζωντανή ροή έληξε"),
        ...
        "loginToContinue":
            MessageLookupByLibrary.simpleMessage("ΕΙΣΟΔΟΣ ΓΙΑ ΣΥΝΕΧΕΙΑ"),
        ...
        "notEligible":
            MessageLookupByLibrary.simpleMessage("ΔΕΝ ΕΙΝΑΙ ΕΠΙΛΕΞΙΜΕΣ"),
        ...
        "pleaseAddSelfiePhoto":
            MessageLookupByLibrary.simpleMessage("Προσθέστε φωτογραφία selfie"),
        ...
        "pleaseValidEmail":
            MessageLookupByLibrary.simpleMessage("Παρακαλώ έγκυρο email"),
        ...
        "redeemRequests":
            MessageLookupByLibrary.simpleMessage("ΕΞΑΡΓΥΡΩΣΗ ΑΙΤΗΜΑΤΩΝ"),
        ...
        "shortIntro":
            MessageLookupByLibrary.simpleMessage("Σύντομη εισαγωγή για εσάς.."),
        ...
        "social":
            MessageLookupByLibrary.simpleMessage("ΣΥΝΔΕΣΜΟΙ ΚΟΙΝΩΝΙΚΟΥ ΠΡΟΦΙΛ"),
        ...
        "startMatching":
            MessageLookupByLibrary.simpleMessage("ΑΡΧΙΣΤΕ ΤΟ ΑΓΩΝΙΣΤΙΚΟ"),
        ...
        "streamYourself":
            MessageLookupByLibrary.simpleMessage("Μεταδώστε τον εαυτό σας"),
        "streamed":
            MessageLookupByLibrary.simpleMessage("  Μετάδοση ροής για:"),
        ...
        "switchMap":
            MessageLookupByLibrary.simpleMessage("Δείξτε μου στον χάρτη"),
        ...
        "termAndCondition":
            MessageLookupByLibrary.simpleMessage("  Οροι και Προϋποθέσεις,"),
        ...
        "toSendMessage":
            MessageLookupByLibrary.simpleMessage("για να στείλετε ένα μήνυμα."),
        "today": MessageLookupByLibrary.simpleMessage("Σήμερα"),
        "tooLarge": MessageLookupByLibrary.simpleMessage("Πολύ μεγάλο"),
        "totalCollection":
            MessageLookupByLibrary.simpleMessage("ΣΥΝΟΛΙΚΗ ΣΥΛΛΟΓΗ"),
        ...
        "verification":
            MessageLookupByLibrary.simpleMessage("Αίτηση για επαλήθευση"),
        ...
        "youAreFakeUser":
            MessageLookupByLibrary.simpleMessage("Είστε ψεύτικος χρήστης"),
        "youAreReporting":
            MessageLookupByLibrary.simpleMessage("Αναφέρετε αυτόν τον χρήστη"),
        "youBlockThisUser":
            MessageLookupByLibrary.simpleMessage("Αποκλείετε αυτόν τον χρήστη"),
        "youMust18": MessageLookupByLibrary.simpleMessage("Πρέπει 18+"),
        "youMustBe18":
            MessageLookupByLibrary.simpleMessage("Πρέπει να είσαι 18+"),
        "youWillBeSentEtc":
            MessageLookupByLibrary.simpleMessage("ΣΥΝΤΟΜΑ ΘΑ ΣΤΕΙΛΕΤΕ ΕΞΩ"),
